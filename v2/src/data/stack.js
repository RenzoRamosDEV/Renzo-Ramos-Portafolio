...
export const STACK = [
  { name: 'Kotlin', icon: '/icons/KOTLIN.png', desc: 'Desarrollo backend y movile con enfoque en arquitectura limpia, servicios escalables.' },
  ...
  { name: 'Maven', icon: '/icons/MAVEN.png', desc: 'Gestión de dependencias y construcción de proyectos.' },
  { name: 'Gradle', icon: '/icons/GRADLE.png', desc: 'Gestión de dependencias y construcción de proyectos.' },
  ...
  { name: 'Claude Design', icon: '/icons/CLAUDEDISEÑO-LOGO.png', desc: 'Agente IA para diseño y maquetación de interfaces.' },
  { name: 'Antigravity', icon: '/icons/ANTIGRAVITY.png', desc: 'IDE para desarrollo Frontend con IA.' },
  { name: 'IntelliJ', icon: '/icons/INTELLIJ.png', desc: 'IDE para desarrollo Backend con maxima productividad.' },
  { name: 'Linux', icon: '/icons/LINUX.png', desc: 'Sistema operativo entorno Linux Ubuntu.' },
  { name: 'Windows', icon: '/icons/WINDOWS.png', desc: 'Sistema operativo entorno Windows.' },
];
