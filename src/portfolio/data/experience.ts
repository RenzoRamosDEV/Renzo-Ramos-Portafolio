...
const EXPERIENCE_RAW: ExperienceItemRaw[] = [
  ...
  },
  {
    ...
    location: 'Madrid, España',
    desc: {
      es: 'Experiencia en el desarrollo de soluciones utilizando Java, XML, HTML, CSS, JavaScript y Maven.\n\n- Desarrollo de componentes reutilizables y contribuibles en AEM\n- Creación de Modals para componentes con Java\n- Gestión y contribución de páginas con contenido multimedia mediante AEM Assets (DAM)\n- Resolución de incidencias backend y optimización de funcionalidades existentes\n- Elaboración de documentación técnica para soporte y mantenimiento de proyectos',
      en: 'Experience developing solutions using Java, XML, HTML, CSS, JavaScript and Maven.\n\n- Development of reusable and contributable components in AEM\n- Creation of Modals for components with Java\n- Management and contribution of pages with multimedia content via AEM Assets (DAM)\n- Resolution of backend incidents and optimization of existing functionalities\n- Preparation of technical documentation for project support and maintenance',
    },
  },
]
